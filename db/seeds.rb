...
course_map={
    ...
    9 => {course_code: "091M5001H", name: "VLSIVLSI测试与可测试性设计", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-16周	", course_time: "周二(9-11)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
